...
import in.jdsoft.educationmanagement.dao.GeographicalLocationDAO;
...
public class GeographicalLocationServices {
	...
	@Transactional
	public void addGeographicalLocation(GeographicalLocation geographicalLocation){
		geographicalLocationDAO.persist(geographicalLocation);
	}
}
