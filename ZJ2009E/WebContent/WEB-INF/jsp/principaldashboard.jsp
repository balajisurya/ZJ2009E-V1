		...
		<div id="page-wrapper">
				...
				<div class="charts">
					...
					<div class="col-md-6 charts chrt-page-grids">
						<h4 class="title">Department Indicators: Student Success Ratio, Student-Staff Ratio, Admission Ratio and Placement Ratio</h4>
					...
					<div class="col-md-6 charts chrt-page-grids chrt-right">
						...
						<div class="pie-grid">
							<canvas id="pie" height="300" width="400" style="width: 400px; height: 290px;"></canvas>
					...
					<div class="col-md-6 charts chrt-page-grids chrt-right">
						...
						<div class="pie-grid">
							<canvas id="pie1" height="300" width="400" style="width: 400px; height: 290px;"></canvas>
					...
					<div class="col-md-6  charts chrt-page-grids">
						...
						<canvas id="line6" height="300" width="400" style="width: 400px; height: 345px;"></canvas>
					...
					<div class="col-md-6  charts chrt-page-grids">
						...
						<canvas id="line2" height="300" width="300" style="width: 400px; height: 300px;"></canvas>
