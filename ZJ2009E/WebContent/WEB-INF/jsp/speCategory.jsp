                                 ...
                                 <c:forEach items="${specialCategoryList}" var="specialCategory">
                                    <tr >
                                       ...
                                       <td>
                                          ...
                                          <a href="#" class="test" id="delete"  type="button" data-href="#"  data-id="${specialCategory.getSpecialCategoryId()}" data-toggle="modal" data-target="#deleteSpecialCategoryConfirmation">
               ...
               <div id="EditFormDiv" style="display:none;">
                  <div class="forms">
                     <div class="row">
                        ...
                        <div class="form-three widget-shadow">
                           <form class="form-horizontal" id="updateSpecialCategoryForm" action="${pageContext.request.contextPath}/specialCategory/editUpdate" method="post">
                              <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Special Category Name<span class="at-required-highlight">*</span></label> 
                                 <div class="col-sm-6"> 
                              ...
                              <div class="row">
                                 <span style="float:left;margin-top:0px;"class="at-required-highlight">Mandatory fields are marked with an asterisk (*)</span>
                                 <div class="col-sm-offset-3">
                                    <a href="#" id="updateSpecialCategory" style="float:right" class="btn btn-success" type="submit" data-id="">
                                    Update
                                    </a>   
                                    <button style="float:right" type="reset" class="btn btn-info">Clear</button>
                                    <button style="float: right" type="button" class="btn btn-danger" onclick="location.reload()">Cancel</button>
