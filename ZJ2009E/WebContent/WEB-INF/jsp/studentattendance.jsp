...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<!-- main content start-->
		<div id="page-wrapper">
		  <h3 class="title1">Student Attendance</h3>
		<div class="main-page">
             ...
             <div class="modal fade" id="confirm-save" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" data-keyboard="false">
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-footer">
                        <button type="button" class="btn btn-primary" name="" id="list" data-dismiss="modal">Yes</button>
                     </div>
                  </div>
               </div>
            </div>
				  ...
				  <form class="form-horizontal">
	             		...
	             		<br>
			   			 <div class="form-group">
                                ...
                                <div class="col-sm-6"> 
                                       <input type="text" name="staffAttendanceDate" class="form-control form-control-datepicker" id="" placeholder="">
                                 </div>
                         </div>
                         <div class="tables">
                                  ...
                                  <c:if test="${!empty studentList}">
		                                <c:forEach items="${studentList}" var="student">
		                                      <tr class="active" id="test">
				                                    ...
				                                    <td style="width:230px">${student.getFirstName()}  ${student.getLastName()}</td>
				                                    <td style="width:230px">${student.getCourses().getCourseName()}</td>
				                                    <td> 
				                                             <select name="studentAttendanceType" id="studentAttendanceType" class="form-control" style="width:250px">
						                                     	<option value="" disabled>Select Attendance</option>
						                                     	<c:if test="${!empty studentAttendanceTypeList}">
						                                     	   <c:forEach items="${studentAttendanceTypeList}" var="studentAttendanceType">
						                                            	 <option value="${studentAttendanceType.getStudentAttendanceTypeId()}">${studentAttendanceType.getStudentAttendanceTypeTitle()}</option>
						                                            </c:forEach>
						                                       </c:if>
						                                    </select>
						                            </td>
		                ...
		                <div class="row">
                                 <div class="col-sm-offset-3">
                                    ...
                                    <button style="float:right"  type="button" id="studentattendance" class="btn btn-success">Save</button>
	...
	<!-- Classie -->
		<script src="${pageContext.request.contextPath}/resources/${theme}/js/classie.js"></script>
		 <script src="${pageContext.request.contextPath}/resources/themes/script/studentattendance.js"></script>
