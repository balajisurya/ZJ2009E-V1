         ...
         <div class="main-page">
            <div id="ListDiv" style="display:block;">
               ...
               <div class="col-md-3 col-sm-3 col-xs-12"> 
                  <button type="button" class="btn btn-info" onclick="showDiv()">Create New Lab Plan</button>
                  </div>
                  <div class="col-md-3 col-sm-3 col-xs-12"> 
                  <button type="button" class="btn btn-success" onclick="showsetupDiv()">Create New Lab Plan Schedule</button>
                  </div> 
               </div>
               <br />
               <br />
               ...
               <br />
                      <h3 class="title1">Lab Plan Schedule</h3> 
                              ...
                              <div class="form-group">
                                ...
                                <div class="row">
                                 <div class="col-sm-offset-3">
                                    <button style="float:right"   type="button" id="labplansave"class="btn btn-success">Add Lab Plan</button>
           ...
           <div id="SetupDiv" style="display:none;">
            ...
            <div class="forms">
                  <div class="row">
                     <h3 class="title1"> New Lab Schedule</h3>
                     <div class="form-three widget-shadow">
                        <form class="form-horizontal">
                        <div class="form-group">
                                       <label for="" class="col-sm-3 control-label">Lab Plan ID/Name </label> 
                                       <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                                ...
                                <div class="row">
                                 <div class="col-sm-offset-3">
                                    <button style="float:right"   id="labplanschedulesave"class="btn btn-success">Add Plan Schedule</button>
                                    <button style="float:right" type="reset" class="btn btn-info">Clear</button>
                                    <button style="float: right" class="btn btn-danger" onclick="showDiv()">Cancel</button>
                                 </div>
                              </div>
...
$(function() {
  ...
  $('input[name="datefilter"]').on('cancel.daterangepicker', function(ev, picker) {
      ...
      <script src="${pageContext.request.contextPath}/resources/themes/script/labs.js" type="text/javascript"></script>
      <!--scrolling js-->
