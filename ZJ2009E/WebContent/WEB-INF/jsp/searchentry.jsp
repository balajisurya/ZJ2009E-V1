...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<!-- main content start-->
		<div id="page-wrapper">
		  <h3 class="title1">View Index</h3>
		<div class="main-page">
		   <form class="form-horizontal">
                    <div class="form-group">
                                 <label for="" class="col-sm-3 control-label">Enter Index ID</label> 
                                 <div class="col-sm-6"> 
                                    <input type="text" class="form-control" id="" placeholder="">
                                 </div>
                              </div>
                               <div class="form-group">
                                 <label for="" class="col-sm-3 control-label"><span>Or</span> Document Reference</label> 
                                 <div class="col-sm-6"> 
                                    <input type="text" class="form-control" id="" placeholder="">
                                 </div>
                              </div>
                              <div class="form-group">
                              <label for="" class="col-sm-3 control-label"><span>Or</span> Search Document From to End Date</label> 
                               <div class="col-sm-6"> 
                                ...
                                <div class="row">
                                 <div class="col-sm-offset-3">
                                    <button style="float:right"   class="btn btn-success">Get Index Details</button>
   ...
   <h3 class="title1">Index Details</h3>
