...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
				...
				<h3 class="title1">Academic Dashboard</h3>
				<div class="charts">
						<div class="col-md-6 chrt-page-grids " style=" height:auto;">
						<h4 class="title">Course Wise Faculty Qualification Index</h4>
					...
					<div class="col-md-6 chrt-page-grids chrt-right">
						<h4 class="title">Course Wise Industry Interest</h4>
						<div class="doughnut-grid">
					...
					<div class="col-md-6 charts chrt-page-grids">
						<h4 class="title">Course Wise Student Success Factors</h4>
					...
					<div class="col-md-6 charts chrt-page-grids chrt-right">
						<h4 class="title">Course Wise Academic Asset Purchases</h4>
					...
					<div class="col-md-6 charts chrt-page-grids">
						<h4 class="title">Course Wise Budget Utilization</h4>
						<div class="doughnut-grid">
							<canvas id="doughnut"  style="width:416px; height: 350px;"></canvas>
							
						</div>
						<div id="d-legend" class="chart-legend"></div>
					</div>
					<div class="col-md-6 charts chrt-page-grids chrt-right">
						<h4 class="title">Key Trends: Course Wise Student Success Ratio</h4>
						<canvas id="line2" height="300" width="300" style="width: 250px; height:400px;"></canvas>
						<div id="l2-legend" class="chart-legend"></div>
					</div>
					<div class="col-md-6 charts chrt-page-grids">
						<h4 class="title">Key Trends: Course Wise Placements</h4>
						<canvas id="line3" height="300" width="400" style="width: 400px; height: 300px;"></canvas>
						<div id="l3-legend" class="chart-legend"></div>
					</div>
					<div class="col-md-6  charts chrt-page-grids chrt-right">
						<h4 class="title">Key Trends: Course Wise Student Grade Drops</h4>
						<canvas id="line4" height="300" width="400" style="width: 400px; height: 300px;"></canvas>
						<div id="l4-legend" class="chart-legend"></div>
					</div>
					<div class="col-md-6 charts chrt-page-grids">
						<h4 class="title">Key Trends: Course Wise At Risk Students</h4>
						<canvas id="line5" height="300" width="400" style="width: 400px; height: 260px;"></canvas>
						<div id="l5-legend" class="chart-legend"></div>
					</div>
					
			<div class="col-md-6  charts chrt-page-grids chrt-right">
						<h4 class="title">Key Trends: Course Wise Industry Interest</h4>
						<div class="line-grid">
						<canvas id="line" height="300" width="400" style="width: 400px; height: 350px;"></canvas>
						</div>
					...
					<div class="col-md-6 charts chrt-page-grids">
						<h4 class="title">Course Wise Student Risk Factors</h4>
						<canvas id="bar2" height="300" width="400" style="width:400px; height: 245px;">
						
						</canvas>
						<div id="b2-legend" class="chart-legend"></div>
					</div>
					<div class="col-md-6 charts chrt-page-grids chrt-right">
						<h4 class="title">Key Trends: Course Wise Student-Staff Ratio</h4>
						<div class="line-grid">
						<canvas id="line6" height="300" width="400" style="width: 400px; height: 300px;"></canvas>
						</div>
						<div id="l6-legend" class="chart-legend"></div>
					...
					<div class="clearfix"> </div>
							...
							var doughnutData = [
									...
									var barChartData2 = {
											labels : ["Physics","Chemistry","Commerce","Management","Social Studies","Elec Engineering"],
											datasets : [
												{
													fillColor : "rgba(233, 78, 2, 0.83)",
													strokeColor : "#ef553a",
													...
													label: "Student Grade Drops Ratio"
												},
												{
													fillColor : "rgba(79, 82, 186, 0.83)",
													strokeColor : "#4F52BA",
													highlightFill: "#4F52BA",
													data : [50,65,60,50,70,70],
													label: "At Risk Students Ratio"
												},
												{
													fillColor : "rgba(88, 88, 88, 0.83)",
													strokeColor : "#585858",
													...
													label: "Student Attendance Ratio"
												},
												{
													fillColor : "#03A9F4",
													strokeColor : "#03A9F4",
													highlightFill: "#03A9F4",
													data : [12,60,20,50,50,40],
													label: "Student-Staff Ratio"
												}
					...
					var l6=	new Chart(document.getElementById("line6").getContext("2d")).Line(lineChartData7);
					var b1=	new Chart(document.getElementById("bar1").getContext("2d")).Bar(barChartDatas);
				
						var b2=	new Chart(document.getElementById("bar2").getContext("2d")).Bar(barChartData2);
						...
						var l5=new Chart(document.getElementById("line5").getContext("2d")).Line(lineChartData5);
							...
							document.getElementById('b2-legend').innerHTML = b2.generateLegend();
